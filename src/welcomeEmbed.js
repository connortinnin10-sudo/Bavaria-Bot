...
function buildDonauworthWelcomeEmbed({ userId, rank }) {
  ...
  const description = [
    ...
    `📯 **INDUCTION**`,
    ``,
    `You have been assigned to **DONAUWÖRTH**. Attend your induction and conduct yourself in accordance with regimental regulations. Upon completing induction you will be posted to an active Füsilier-Kompanie and promoted to the rank of Soldat.`,
    ``,
    `**-**`,
    ``,
    `🎖️ **ADVANCEMENT, HONOURS, AWARDS**`,
    ``,
    `Every Bavarian once stood where you stand today. Advancement is awarded to those who distinguish themselves through steadfast attendance, discipline, loyalty, and exemplary conduct both on and off the field. You can expect to see promotions listed weekly.`,
    ``,
    `**━**`,
    ``,
    `The regiment marches as one, and every soldier strengthens its line. Carry yourself with honor, obey your officers, and stand firm beneath the Bavarian colors.`,
